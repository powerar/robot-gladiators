...
var endGame = function() {
    ...
    //check localStorte for high score, if it's not there, use 0
...
var fightOrSkip = function() {
  ...
  //fight function (no with parameter for enemy's name)
var fight = function(enemy) {
    ...
    while (playerInfo.health > 0 && enemy.health > 0) {
        if (isPlayerTurn) {
            // ask player if they'd like to fght or skip using fightOrSkip function
            if (fightOrSkip()) {
            break;
        }
...
var playerInfo = {
    ...
    refillHealth: function() {
        if (this.money >= 7) {
            window.alert("Refilling play's health by 20 for 7 dollars.");
            this.health += 20;
            this.money -= 7;
        }
        else {
            window.alert("You don't have engouh money!");
        }
    },
